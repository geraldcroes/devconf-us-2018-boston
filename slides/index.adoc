...
== Whoami
* Gerald Croes - @geraldcroes link:https://twitter.com/geraldcroes[icon:twitter[]] link:https://medium.com/@geraldcroes[icon:medium[]] link:https://github.com/geraldcroes[icon:github[]]
